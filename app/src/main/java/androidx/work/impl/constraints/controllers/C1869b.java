...
public final class C1869b extends AbstractC1870c<Boolean> {
    public C1869b(Context context, InterfaceC1998a interfaceC1998a) {
        super(C1889h.m9842a(context, interfaceC1998a).f4584b);
    }

    @Override // androidx.work.impl.constraints.controllers.AbstractC1870c
    /* renamed from: b */
    public final boolean mo9857b(@NonNull C1940p c1940p) {
        return c1940p.f4699j.f4447d;
    }
