...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private InterfaceC1490s<InterfaceC1483m> mObserver;
    ...
    public DialogFragment() {
        ...
        this.mBackStackId = -1;
        this.mObserver = new InterfaceC1490s<InterfaceC1483m>() { // from class: androidx.fragment.app.DialogFragment.4
            @Override // androidx.lifecycle.InterfaceC1490s
            @SuppressLint({"SyntheticAccessor"})
            public void onChanged(InterfaceC1483m interfaceC1483m) {
                if (interfaceC1483m == null || !DialogFragment.this.mShowsDialog) {
                    return;
                }
    ...
    public void onAttach(@NonNull Context context) {
        ...
        getViewLifecycleOwnerLiveData().m10572e(this.mObserver);
        if (this.mShownByMe) {
            return;
        }
    ...
    public Dialog onCreateDialog(@Nullable Bundle bundle) {
        ...
        return new DialogC0048j(requireContext(), getTheme());
    }
    ...
    public void onDetach() {
        ...
        getViewLifecycleOwnerLiveData().mo10511h(this.mObserver);
    }
    ...
    @NonNull
    public final DialogC0048j requireComponentDialog() {
        Dialog requireDialog = requireDialog();
        if (requireDialog instanceof DialogC0048j) {
            return (DialogC0048j) requireDialog;
        }
