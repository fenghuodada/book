...
public class FragmentController {
    ...
    @Deprecated
    public void restoreLoaderNonConfig(@SuppressLint({"UnknownNullness"}) C0482i<String, AbstractC1515a> c0482i) {
    }
    ...
    @Nullable
    @Deprecated
    public C0482i<String, AbstractC1515a> retainLoaderNonConfig() {
        return null;
    }
