...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: i */
    public static int m12796i(View view) {
        WeakHashMap<View, C0922g2> weakHashMap = ViewCompat.f2518a;
        int m11761d = ViewCompat.C0814d.m11761d(view);
        if (m11761d > 0) {
            return m11761d;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m12796i(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    */
    public final void onLayout(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        L50:
            ...
            androidx.appcompat.widget.LinearLayoutCompat$a r6 = (androidx.appcompat.widget.LinearLayoutCompat.C0250a) r6
            int r7 = r6.gravity
            if (r7 >= 0) goto L73
            r7 = r2
        L73:
            java.util.WeakHashMap<android.view.View, androidx.core.view.g2> r8 = androidx.core.view.ViewCompat.f2518a
            int r8 = androidx.core.view.ViewCompat.C0815e.m11742d(r9)
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    LinearLayoutCompat.C0250a c0250a = (LinearLayoutCompat.C0250a) childAt3.getLayoutParams();
                    if (((LinearLayout.LayoutParams) c0250a).width == -1) {
                        int i13 = ((LinearLayout.LayoutParams) c0250a).height;
                        ((LinearLayout.LayoutParams) c0250a).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, makeMeasureSpec2, 0, i2, 0);
                        ((LinearLayout.LayoutParams) c0250a).height = i13;
                    }
                }
            }
        }
