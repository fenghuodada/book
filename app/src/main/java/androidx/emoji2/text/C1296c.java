...
public final class C1296c {
    ...
    public static class C1297a {
        @NonNull
        /* renamed from: a */
        public Signature[] mo10678a(@NonNull PackageManager packageManager, @NonNull String str) throws PackageManager.NameNotFoundException {
    ...
    /* loaded from: classes.dex */
    public static class C1298b extends C1297a {
    }
    ...
    /* loaded from: classes.dex */
    public static class C1299c extends C1298b {
        @Override // androidx.emoji2.text.C1296c.C1297a
        @NonNull
        /* renamed from: a */
        public final Signature[] mo10678a(@NonNull PackageManager packageManager, @NonNull String str) throws PackageManager.NameNotFoundException {
            return packageManager.getPackageInfo(str, 64).signatures;
        }
    }
    ...
    */
    public static androidx.emoji2.text.C1311j m10679a(@androidx.annotation.NonNull android.content.Context r8) {
        /*
        ...
        L11:
            ...
            androidx.core.util.C0804h.m11791c(r1, r2)
        ...
        L4e:
            ...
            android.content.pm.Signature[] r0 = r0.mo10678a(r1, r4)     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L76
        ...
        L6a:
            ...
            androidx.core.provider.h r1 = new androidx.core.provider.h     // Catch: android.content.pm.PackageManager.NameNotFoundException -> L76
        ...
        L85:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.emoji2.text.C1296c.m10679a(android.content.Context):androidx.emoji2.text.j");
    }
}
