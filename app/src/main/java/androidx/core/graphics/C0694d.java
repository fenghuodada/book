...
public final class C0694d {
    ...
    public static class C0695a {
        ...
        public C0695a(char c, float[] fArr) {
            this.f2389a = c;
            this.f2390b = fArr;
        }

        public C0695a(C0695a c0695a) {
            this.f2389a = c0695a.f2389a;
            float[] fArr = c0695a.f2390b;
            this.f2390b = C0694d.m11962b(fArr, fArr.length);
        }

        /* renamed from: a */
        public static void m11958a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            double d;
            double d2;
            ...
            if (d20 < 0.0d) {
                ...
                m11958a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
        ...
        /* renamed from: b */
        public static void m11957b(C0695a[] c0695aArr, Path path) {
            int i;
            int i2;
            char c;
            C0695a c0695a;
            ...
            char c3 = 'm';
            int i6 = 0;
            while (i6 < c0695aArr2.length) {
                C0695a c0695a2 = c0695aArr2[i6];
                char c4 = c0695a2.f2389a;
                float f22 = fArr[i5];
                float f23 = fArr[1];
                float f24 = fArr[2];
                float f25 = fArr[3];
                ...
                while (true) {
                    ...
                    if (i7 < fArr2.length) {
                        if (c4 != 'A') {
                                    ...
                                    if (c4 != 'Q') {
                                        if (c4 != 'V') {
                                            if (c4 != 'a') {
                                                ...
                                                c0695a = c0695a2;
                                                i3 = i6;
                                                m11958a(path, f51, f50, f52, f53, f54, f55, f56, z3, z4);
                                                f30 = f51 + fArr2[i34];
                                                f31 = f50 + fArr2[i35];
                                            }
                                        } else {
                            ...
                            m11958a(path, f60, f59, f61, f62, f63, f64, f65, z, z2);
                            f30 = fArr2[i46];
                            f31 = fArr2[i47];
                        }
                        f25 = f31;
                ...
                c2 = 'm';
                i5 = i49;
                c3 = c0695aArr[i48].f2389a;
                c0695aArr2 = c0695aArr;
            }
        }
    }

    /* renamed from: a */
    public static boolean m11963a(@Nullable C0695a[] c0695aArr, @Nullable C0695a[] c0695aArr2) {
        if (c0695aArr == null || c0695aArr2 == null || c0695aArr.length != c0695aArr2.length) {
            return false;
        }
        for (int i = 0; i < c0695aArr.length; i++) {
            C0695a c0695a = c0695aArr[i];
            char c = c0695a.f2389a;
            C0695a c0695a2 = c0695aArr2[i];
            if (c != c0695a2.f2389a || c0695a.f2390b.length != c0695a2.f2390b.length) {
                return false;
            }
        }
        return true;
    ...
    /* renamed from: b */
    public static float[] m11962b(float[] fArr, int i) {
        if (i >= 0) {
    ...
    */
    public static androidx.core.graphics.C0694d.C0695a[] m11961c(java.lang.String r17) {
        /*
            Method dump skipped, instructions count: 276
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.C0694d.m11961c(java.lang.String):androidx.core.graphics.d$a[]");
    }

    /* renamed from: d */
    public static Path m11960d(String str) {
        Path path = new Path();
        C0695a[] m11961c = m11961c(str);
        if (m11961c != null) {
            try {
                C0695a.m11957b(m11961c, path);
                return path;
            } catch (RuntimeException e) {
                throw new RuntimeException(C0552c.m12192b("Error in parsing ", str), e);
            }
        }
        return null;
    }
    ...
    /* renamed from: e */
    public static C0695a[] m11959e(C0695a[] c0695aArr) {
        if (c0695aArr == null) {
            return null;
        }
        C0695a[] c0695aArr2 = new C0695a[c0695aArr.length];
        for (int i = 0; i < c0695aArr.length; i++) {
            c0695aArr2[i] = new C0695a(c0695aArr[i]);
        }
        return c0695aArr2;
    }
}
