...
public final class AutoSizeConfig {
    ...
    public AutoSizeConfig init(final Application application, boolean z, AutoAdaptStrategy autoAdaptStrategy) {
        ...
        AutoSizeLog.m96d("designWidthInDp = " + this.mDesignWidthInDp + ", designHeightInDp = " + this.mDesignHeightInDp + ", screenWidth = " + this.mScreenWidth + ", screenHeight = " + this.mScreenHeight);
            ...
            public void onConfigurationChanged(Configuration configuration2) {
                if (configuration2 != null) {
                    if (configuration2.fontScale > 0.0f) {
                        ...
                        AutoSizeLog.m96d("initScaledDensity = " + AutoSizeConfig.this.mInitScaledDensity + " on ConfigurationChanged");
                    }
        ...
        AutoSizeLog.m96d("initDensity = " + this.mInitDensity + ", initScaledDensity = " + this.mInitScaledDensity);
