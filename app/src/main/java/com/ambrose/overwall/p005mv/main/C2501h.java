...
/* renamed from: com.ambrose.overwall.mv.main.h */
/* loaded from: classes.dex */
public final class C2501h implements InterfaceC10174b<TitleBean> {

    /* renamed from: b */
    public final /* synthetic */ C2506m f5964b;

    public C2501h(C2506m c2506m) {
        this.f5964b = c2506m;
    }
    ...
    public final void accept(TitleBean titleBean) throws Throwable {
        ...
        if (titleBean2 != null && titleBean2.getResults().size() != 0) {
            ...
            edit.apply();
            this.f5964b.f5973d.mo10510i(titleBean2.getResults().get(0));
        }
    }
}
