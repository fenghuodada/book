...
public class CachedSettingsIo {
    ...
    public JSONObject readCachedSettings() {
        ...
        Logger.getLogger().m3348d("Checking for cached settings...");
            ...
            try {
                ...
                if (settingsFile.exists()) {
                    ...
                    try {
                        ...
                        e = e;
                        Logger.getLogger().m3345e("Failed to fetch cached settings", e);
                        CommonUtils.closeOrLog(fileInputStream, "Error while closing settings cache file.");
                        return null;
                    }
                } else {
                    Logger.getLogger().m3342v("Settings file does not exist.");
                    jSONObject = null;
                }
    ...
    public void writeCachedSettings(long j, JSONObject jSONObject) {
        Logger.getLogger().m3342v("Writing settings to cache file...");
        if (jSONObject == null) {
            return;
        }
        ...
        try {
            try {
                ...
                try {
                    ...
                    Logger.getLogger().m3345e("Failed to cache settings", e);
