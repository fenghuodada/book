...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public static /* synthetic */ String lambda$getComponents$2(Context context) {
        return context.getPackageManager().hasSystemFeature("android.hardware.type.television") ? "tv" : context.getPackageManager().hasSystemFeature("android.hardware.type.watch") ? "watch" : context.getPackageManager().hasSystemFeature("android.hardware.type.automotive") ? V2rayConfig.DEFAULT_SECURITY : (Build.VERSION.SDK_INT < 26 || !context.getPackageManager().hasSystemFeature("android.hardware.type.embedded")) ? "" : "embedded";
    }
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new C0484a()));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new C0063d()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new C0486c()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new C0499a()));
