...
import androidx.core.p003os.C0752s;
...
public class FirebaseApp {
    ...
    @GuardedBy("LOCK")
    static final Map<String, FirebaseApp> INSTANCES = new C0470b();
    ...
    public FirebaseApp(final Context context, String str, FirebaseOptions firebaseOptions) {
        ...
        ComponentRuntime.Builder processor = ComponentRuntime.builder(UiExecutor.INSTANCE).addLazyComponentRegistrars(discoverLazy).addComponentRegistrar(new FirebaseCommonRegistrar()).addComponentRegistrar(new ExecutorsRegistrar()).addComponent(Component.m3399of(context, Context.class, new Class[0])).addComponent(Component.m3399of(this, FirebaseApp.class, new Class[0])).addComponent(Component.m3399of(firebaseOptions, FirebaseOptions.class, new Class[0])).setProcessor(new ComponentMonitor());
        if (C0752s.m11830a(context) && FirebaseInitProvider.isCurrentlyInitializing()) {
            processor.addComponent(Component.m3399of(startupTime, StartupTime.class, new Class[0]));
        }
    ...
    public void initializeAllApis() {
        if (!C0752s.m11830a(this.applicationContext)) {
