...
public final class Component<T> {
    ...
    @Deprecated
    /* renamed from: of */
    public static <T> Component<T> m3401of(Class<T> cls, final T t) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m3400of(final T t, Qualified<T> qualified, Qualified<? super T>... qualifiedArr) {
    ...
    @SafeVarargs
    /* renamed from: of */
    public static <T> Component<T> m3399of(final T t, Class<T> cls, Class<? super T>... clsArr) {
