...
public final class SessionDetails {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof SessionDetails) {
            ...
            return C10843j.m435a(this.sessionId, sessionDetails.sessionId) && C10843j.m435a(this.firstSessionId, sessionDetails.firstSessionId) && this.sessionIndex == sessionDetails.sessionIndex && this.sessionStartTimestampUs == sessionDetails.sessionStartTimestampUs;
        }
        return false;
    }
    ...
    public int hashCode() {
        ...
        return ((C0406q1.m12537a(str, this.sessionId.hashCode() * 31, 31) + this.sessionIndex) * 31) + ((int) (j ^ (j >>> 32)));
    }
