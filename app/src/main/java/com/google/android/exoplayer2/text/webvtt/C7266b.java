...
public final class C7266b implements InterfaceC7209c {

    /* renamed from: a */
    public final List<Cue> f13327a;

    public C7266b(ArrayList arrayList) {
        this.f13327a = Collections.unmodifiableList(arrayList);
    }
    ...
    public final List<Cue> mo5281c(long j) {
        return j >= 0 ? this.f13327a : Collections.emptyList();
    }
