...
public final class zzbue extends AbstractSafeParcelable {
    ...
    public zzbue(@SafeParcelable.Param(m4844id = 2) ParcelFileDescriptor parcelFileDescriptor) {
        ...
        if (this.zza == null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        zzcag.zza.execute(new Runnable() { // from class: com.google.android.gms.internal.ads.zzbud
                            @Override // java.lang.Runnable
                            public final void run() {
                                OutputStream outputStream = autoCloseOutputStream;
                                byte[] bArr = marshall;
                                Parcelable.Creator<zzbue> creator = zzbue.CREATOR;
                                ...
                                try {
                                    try {
                                        ...
                                        try {
                                            ...
                                            zzbzt.zzh("Error transporting the ad response", e);
    ...
    public final SafeParcelable zza(Parcelable.Creator creator) {
        if (this.zzc) {
            if (this.zza == null) {
                zzbzt.zzg("File descriptor is empty, returning null.");
                return null;
            }
            ...
            try {
                try {
                    ...
                    zzbzt.zzh("Could not read from parcel file descriptor", e);
                    IOUtils.closeQuietly(dataInputStream);
                    return null;
                }
            } catch (Throwable th2) {
