...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    private final Map zzb = DesugarCollections.synchronizedMap(new C0470b());
    private int zzc = 0;
    @Nullable
    private Bundle zzd;
    ...
    public final void addCallback(String str, @NonNull LifecycleCallback lifecycleCallback) {
        ...
        throw new IllegalArgumentException(C0663f.m12005a("LifecycleCallback with tag ", str, " already added to this fragment."));
    }
