...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    int zad;
    boolean zae;
    @SafeParcelable.Field(getter = "getColumns", m4845id = 1)
    private final String[] zag;
    @SafeParcelable.Field(getter = "getWindows", m4845id = 2)
    private final CursorWindow[] zah;
    @SafeParcelable.Field(getter = "getStatusCode", m4845id = 3)
    private final int zai;
    @Nullable
    @SafeParcelable.Field(getter = "getMetadata", m4845id = 4)
    ...
    public DataHolder(@SafeParcelable.Param(m4844id = 1000) int i, @SafeParcelable.Param(m4844id = 1) String[] strArr, @SafeParcelable.Param(m4844id = 2) CursorWindow[] cursorWindowArr, @SafeParcelable.Param(m4844id = 3) int i2, @Nullable @SafeParcelable.Param(m4844id = 4) Bundle bundle) {
        this.zae = false;
        this.zak = true;
        this.zaa = i;
        this.zag = strArr;
