...
public final class zzdgl extends zzbem {
    ...
    public final float zzf() throws RemoteException {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzfY)).booleanValue() && this.zza.zzj() != null) {
    ...
    public final boolean zzl() throws RemoteException {
        return ((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzfY)).booleanValue() && this.zza.zzj() != null;
    }

    @Override // com.google.android.gms.internal.ads.zzben
    public final void zzm(zzbfy zzbfyVar) {
        if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzfY)).booleanValue() && (this.zza.zzj() instanceof zzcfx)) {
            ((zzcfx) this.zza.zzj()).zzv(zzbfyVar);
        }
    }
}
