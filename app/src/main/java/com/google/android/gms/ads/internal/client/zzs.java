...
public final class zzs extends AbstractSafeParcelable {
    ...
    public zzs(@SafeParcelable.Param(m4844id = 1) int i, @SafeParcelable.Param(m4844id = 2) int i2, @SafeParcelable.Param(m4844id = 3) String str, @SafeParcelable.Param(m4844id = 4) long j) {
        this.zza = i;
        this.zzb = i2;
        this.zzc = str;
        this.zzd = j;
