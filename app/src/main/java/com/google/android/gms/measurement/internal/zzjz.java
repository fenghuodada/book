...
public final class zzjz extends zzf {
    ...
    private final zzq zzO(boolean z) {
        ...
        if (z) {
            ...
            if (zzaA.zzt.zzm().zzb != null && (zza = zzaA.zzt.zzm().zzb.zza()) != null && zza != zzfi.zza) {
                str = C0485b.m12391a(String.valueOf(zza.second), ":", (String) zza.first);
            }
        }
        return zzh.zzj(str);
    }
    ...
    private final void zzR(Runnable runnable) throws IllegalStateException {
        ...
        if (this.zzf.size() >= 1000) {
            C6652m.m6131a(this.zzt, "Discarding data. Max runnable queue size reached");
            return;
        }
        ...
        while (i2 < 1001 && i3 == 100) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (abstractSafeParcelable2 instanceof zzau) {
                    ...
                    C6652m.m6131a(this.zzt, "Discarding data. Unrecognized parcel type.");
                }
            }
            i2++;
            i3 = i;
    ...
    public final void zzr() {
        ...
        if (!zzN()) {
            if (!this.zzt.zzf().zzx()) {
                ...
                C6652m.m6131a(this.zzt, "Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
                return;
            }
            return;
        }
