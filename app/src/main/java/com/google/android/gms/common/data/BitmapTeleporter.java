...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public BitmapTeleporter(@SafeParcelable.Param(m4844id = 1) int i, @SafeParcelable.Param(m4844id = 2) ParcelFileDescriptor parcelFileDescriptor, @SafeParcelable.Param(m4844id = 3) int i2) {
        this.zaa = i;
