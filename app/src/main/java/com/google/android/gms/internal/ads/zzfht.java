...
public final class zzfht {
    ...
    public static JSONObject zza(int i, int i2, int i3, int i4) {
        ...
        try {
            ...
            zzfhu.zza("Error with creating viewStateObject", e);
        }
        return jSONObject;
    }
    ...
    public static void zzb(JSONObject jSONObject, String str) {
        try {
            ...
            zzfhu.zza("Error with setting ad session id", e);
        }
    }
    ...
    public static void zze(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            zzfhu.zza("JSONException during JSONObject.put for name [" + str + "]", e);
        }
    }
