...
public final class GoogleServices {
    ...
    public GoogleServices(Context context) {
        ...
        int identifier = resources.getIdentifier("google_app_measurement_enable", "integer", resources.getResourcePackageName(C7524R.string.common_google_play_services_unknown_issue));
        if (identifier != 0) {
    ...
    public Status checkGoogleAppId(String str) {
        ...
        if (str2 != null && !str2.equals(str)) {
            return new Status(10, C0663f.m12005a("Initialize was called with two different Google App IDs.  Only the first app ID will be used: '", this.zzc, "'."));
        }
