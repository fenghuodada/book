...
public final class WebImage extends AbstractSafeParcelable {
    ...
    final int zaa;
    @SafeParcelable.Field(getter = "getUrl", m4845id = 2)
    private final Uri zab;
    @SafeParcelable.Field(getter = "getWidth", m4845id = 3)
    private final int zac;
    @SafeParcelable.Field(getter = "getHeight", m4845id = 4)
    private final int zad;

    @SafeParcelable.Constructor
    public WebImage(@SafeParcelable.Param(m4844id = 1) int i, @SafeParcelable.Param(m4844id = 2) Uri uri, @SafeParcelable.Param(m4844id = 3) int i2, @SafeParcelable.Param(m4844id = 4) int i3) {
        this.zaa = i;
        this.zab = uri;
        this.zac = i2;
        this.zad = i3;
