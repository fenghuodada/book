...
public final class zziz extends zzf {
    ...
    public final void zzA(zzir zzirVar, zzir zzirVar2, long j, boolean z, Bundle bundle) {
        ...
        if (z3) {
            ...
            String str3 = true != zzirVar.zze ? V2rayConfig.DEFAULT_SECURITY : "app";
    ...
    public final void zzr(Activity activity, Bundle bundle) {
        ...
        this.zzd.put(activity, new zzir(bundle2.getString("name"), bundle2.getString("referrer_name"), bundle2.getLong(FacebookAdapter.KEY_ID)));
    }
    ...
    public final void zzv(Activity activity, Bundle bundle) {
        ...
        bundle2.putLong(FacebookAdapter.KEY_ID, zzirVar.zzc);
