...
public final class zzdtu {
    ...
    public static final void zzb(Context context, ViewGroup viewGroup, NativeAd nativeAd) {
        ...
        linearLayout.addView(zzc(context, zzd == null ? "Headline" : zzd.getString(C7513R.string.native_headline), "headline_header_tag"));
        View zzd2 = zzd(context, zzfpo.zzc(nativeAd.getHeadline()), "headline_tag");
        nativeAdView.setHeadlineView(zzd2);
        linearLayout.addView(zzd2);
        linearLayout.addView(zzc(context, zzd == null ? "Body" : zzd.getString(C7513R.string.native_body), "body_header_tag"));
        View zzd3 = zzd(context, zzfpo.zzc(nativeAd.getBody()), "body_tag");
        nativeAdView.setBodyView(zzd3);
        linearLayout.addView(zzd3);
        linearLayout.addView(zzc(context, zzd == null ? "Media View" : zzd.getString(C7513R.string.native_media_view), "media_view_header_tag"));
