...
import com.google.android.gms.ads.C7509R;
...
public final class zzy {
    ...
    public zzy(Context context, AttributeSet attributeSet) {
        TypedArray obtainAttributes = context.getResources().obtainAttributes(attributeSet, C7509R.styleable.AdsAttrs);
        String string = obtainAttributes.getString(C7509R.styleable.AdsAttrs_adSize);
        String string2 = obtainAttributes.getString(C7509R.styleable.AdsAttrs_adSizes);
        ...
        String string3 = obtainAttributes.getString(C7509R.styleable.AdsAttrs_adUnitId);
        this.zzb = string3;
        obtainAttributes.recycle();
