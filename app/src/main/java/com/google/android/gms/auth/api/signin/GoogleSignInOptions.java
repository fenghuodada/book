...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Api.ApiOptions.Optional, ReflectedParcelable {
    ...
    final int zaf;
    @SafeParcelable.Field(getter = "getScopes", m4845id = 2)
    private final ArrayList<Scope> zah;
    @Nullable
    @SafeParcelable.Field(getter = "getAccount", m4845id = 3)
    private Account zai;
    @SafeParcelable.Field(getter = "isIdTokenRequested", m4845id = 4)
    private boolean zaj;
    @SafeParcelable.Field(getter = "isServerAuthCodeRequested", m4845id = 5)
    private final boolean zak;
    @SafeParcelable.Field(getter = "isForceCodeForRefreshToken", m4845id = 6)
    private final boolean zal;
    @Nullable
    @SafeParcelable.Field(getter = "getServerClientId", m4845id = 7)
    private String zam;
    @Nullable
    @SafeParcelable.Field(getter = "getHostedDomain", m4845id = 8)
    private String zan;
    @SafeParcelable.Field(getter = "getExtensions", m4845id = 9)
    private ArrayList<GoogleSignInOptionsExtensionParcelable> zao;
    @Nullable
    @SafeParcelable.Field(getter = "getLogSessionId", m4845id = 10)
    private String zap;
    ...
    public GoogleSignInOptions(@SafeParcelable.Param(m4844id = 1) int i, @SafeParcelable.Param(m4844id = 2) ArrayList<Scope> arrayList, @Nullable @SafeParcelable.Param(m4844id = 3) Account account, @SafeParcelable.Param(m4844id = 4) boolean z, @SafeParcelable.Param(m4844id = 5) boolean z2, @SafeParcelable.Param(m4844id = 6) boolean z3, @Nullable @SafeParcelable.Param(m4844id = 7) String str, @Nullable @SafeParcelable.Param(m4844id = 8) String str2, @SafeParcelable.Param(m4844id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2, @Nullable @SafeParcelable.Param(m4844id = 10) String str3) {
