...
public final class zzgpv extends zzgmy implements RandomAccess, zzgpe, zzgqn {
    ...
    private zzgpv(long[] jArr, int i, boolean z) {
        super(z);
        this.zzb = jArr;
        this.zzc = i;
    }
    ...
    /* renamed from: zza */
    public final zzgpe zzd(int i) {
        if (i >= this.zzc) {
            return new zzgpv(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
