...
final class zzgnc extends zzgmy implements RandomAccess, zzgqn {
    ...
    private zzgnc(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzgpg.zzd;
        collection.getClass();
        if (collection instanceof zzgnc) {
            zzgnc zzgncVar = (zzgnc) collection;
            int i = zzgncVar.zzc;
            if (i == 0) {
                return false;
            }
            ...
            if (Integer.MAX_VALUE - i2 >= i) {
                ...
                System.arraycopy(zzgncVar.zzb, 0, this.zzb, this.zzc, zzgncVar.zzc);
                this.zzc = i3;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzgnc) {
            ...
            if (this.zzc != zzgncVar.zzc) {
                return false;
            }
            boolean[] zArr = zzgncVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgpf zzd(int i) {
        if (i >= this.zzc) {
            return new zzgnc(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
