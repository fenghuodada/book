                ...
                if (zzj == null) {
                    ...
                    try {
                        ...
                        if (zzlmVar == null || zzlmVar.zze == null) {
                            zzlm zzlmVar2 = new zzlm(zzv, V2rayConfig.DEFAULT_SECURITY, "_lte", zzr.zzt.zzax().currentTimeMillis(), 0L);
                            zzu2.add(zzlmVar2);
                        ...
                        if (zzu3.zzt.zzg().zze()) {
                            ...
                            if (zzj.zzam() && zzu3.zzf.zzm().zzn(zzv2)) {
                                ...
                                zzu2.add(new zzlm(zzv2, V2rayConfig.DEFAULT_SECURITY, "_npa", zzu3.zzt.zzax().currentTimeMillis(), 1L));
                            }
                        }
