...
public final class zzak extends zzku {
    ...
    */
    ...
    public final void zzD(zzh zzhVar) {
        ...
        contentValues.put(AdColonyAdapterUtils.KEY_APP_ID, zzv);
    ...
    public final void zzE(zzaq zzaqVar) {
        ...
        zzW();
        ContentValues contentValues = new ContentValues();
        contentValues.put(AdColonyAdapterUtils.KEY_APP_ID, zzaqVar.zza);
    ...
    public final boolean zzL(zzlm zzlmVar) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put(AdColonyAdapterUtils.KEY_APP_ID, zzlmVar.zza);
    ...
    */
    ...
    public final Object zzq(Cursor cursor, int i) {
            ...
            if (type != 1) {
                if (type != 2) {
                    if (type != 3) {
                        ...
                        C6652m.m6131a(this.zzt, "Loaded invalid blob type value, ignoring it");
                        return null;
                    }
        ...
        C6652m.m6131a(this.zzt, "Loaded invalid null value from database");
        return null;
    }
    ...
    */
    ...
    public final void zzy(List list) {
        ...
        String m12005a = C0663f.m12005a("(", TextUtils.join(",", list), ")");
        if (zzZ(C0663f.m12005a("SELECT COUNT(1) FROM queue WHERE rowid IN ", m12005a, " AND retry_count =  2147483647 LIMIT 1"), null) > 0) {
            this.zzt.zzaA().zzk().zza("The number of upload retries exceeds the limit. Will remain unchanged.");
        }
        try {
            SQLiteDatabase zzh2 = zzh();
            zzh2.execSQL("UPDATE queue SET retry_count = IFNULL(retry_count, 0) + 1 WHERE rowid IN " + m12005a + " AND (retry_count IS NULL OR retry_count < 2147483647)");
        } catch (SQLiteException e) {
