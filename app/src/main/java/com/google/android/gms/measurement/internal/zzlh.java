...
public final class zzlh implements zzgy {
    ...
    private final void zzaf(com.google.android.gms.internal.measurement.zzgc zzgcVar, long j, boolean z) {
        ...
        zzlm zzlmVar = (zzp == null || zzp.zze == null) ? new zzlm(zzgcVar.zzaq(), V2rayConfig.DEFAULT_SECURITY, str, zzax().currentTimeMillis(), Long.valueOf(j)) : new zzlm(zzgcVar.zzaq(), V2rayConfig.DEFAULT_SECURITY, str, zzax().currentTimeMillis(), Long.valueOf(((Long) zzp.zze).longValue() + j));
        ...
        try {
            ...
            if (zze != null) {
                if (!TextUtils.isEmpty(zzh)) {
                    c0470b = new C0470b();
                    c0470b.put("If-Modified-Since", zzh);
                }
            ...
            zzezVar.zzt.zzaB().zzo(new zzey(zzezVar, str, url, null, c0470b, zzkzVar));
    ...
    public final void zzE(zzau zzauVar, zzq zzqVar) {
        ...
        if (zzlj.zzB(zza, zzqVar)) {
            ...
            try {
                ...
                if (i < 0) {
                    zzakVar2.zzt.zzaA().zzk().zzc("Invalid time querying timed out conditional properties", zzet.zzn(str3), Long.valueOf(j));
                    zzt = Collections.emptyList();
                } else {
                    zzt = zzakVar2.zzt("active=0 and app_id=? and abs(? - creation_timestamp) > trigger_timeout", new String[]{str3, String.valueOf(j)});
                }
                ...
                zzakVar4.zzW();
                if (i < 0) {
                    zzakVar4.zzt.zzaA().zzk().zzc("Invalid time querying expired conditional properties", zzet.zzn(str3), Long.valueOf(j));
                    zzt2 = Collections.emptyList();
                } else {
                    zzt2 = zzakVar4.zzt("active<>0 and app_id=? and abs(? - triggered_timestamp) > time_to_live", new String[]{str3, String.valueOf(j)});
                }
                ...
                zzakVar7.zzW();
                if (i < 0) {
                    zzakVar7.zzt.zzaA().zzk().zzd("Invalid time querying triggered conditional properties", zzet.zzn(str3), zzakVar7.zzt.zzj().zzd(str4), Long.valueOf(j));
                    zzt3 = Collections.emptyList();
                } else {
                    zzt3 = zzakVar7.zzt("active=0 and app_id=? and trigger_event_name=? and abs(? - creation_timestamp) <= trigger_timeout", new String[]{str3, str4, String.valueOf(j)});
                }
    ...
    public final void zzG(zzau zzauVar, zzq zzqVar) {
        ...
        if ("_cmp".equals(zza.zza) && "referrer API v2".equals(zza.zzb.zzg("_cis"))) {
            ...
            if (!TextUtils.isEmpty(zzg)) {
                zzW(new zzlk("_lgclid", zza.zzd, zzg, V2rayConfig.DEFAULT_SECURITY), zzqVar);
            }
        }
        zzE(zza, zzqVar);
    }
    ...
    public final void zzP(String str, zzq zzqVar) {
        ...
        if (zzak(zzqVar)) {
            if (!zzqVar.zzh) {
                ...
                zzW(new zzlk("_npa", zzax().currentTimeMillis(), Long.valueOf(true != zzqVar.zzr.booleanValue() ? 0L : 1L), V2rayConfig.DEFAULT_SECURITY), zzqVar);
            } else {
            ...
            if (zzqVar.zzo && !"00000000-0000-0000-0000-000000000000".equals(this.zzk.zzd(zzqVar.zza, zzd).first)) {
                ...
                if (zzakVar2.zzp(zzqVar.zza, "_id") != null) {
                    ...
                    if (zzakVar3.zzp(zzqVar.zza, "_lair") == null) {
                        zzlm zzlmVar = new zzlm(zzqVar.zza, V2rayConfig.DEFAULT_SECURITY, "_lair", zzax().currentTimeMillis(), 1L);
                        zzak zzakVar4 = this.zze;
                        zzal(zzakVar4);
