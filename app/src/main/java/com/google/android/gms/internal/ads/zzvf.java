...
public final class zzvf {
    ...
    private zzvf(int i, Random random) {
        this(new int[0], random);
    }

    private zzvf(int[] iArr, Random random) {
        this.zzb = iArr;
        this.zza = random;
    ...
    public final zzvf zzg(int i, int i2) {
        int[] iArr = new int[i2];
        ...
        while (true) {
            ...
            if (i3 >= iArr4.length + i2) {
                return new zzvf(iArr3, new Random(this.zza.nextLong()));
            }
            if (i6 >= i2 || i7 != iArr[i6]) {
                int i8 = i7 + 1;
                int i9 = iArr4[i7];
    ...
    public final zzvf zzh(int i, int i2) {
        ...
        while (true) {
            int[] iArr2 = this.zzb;
            if (i3 >= iArr2.length) {
                return new zzvf(iArr, new Random(this.zza.nextLong()));
            }
            int i5 = iArr2[i3];
            if (i5 < 0 || i5 >= i2) {
                int i6 = i3 - i4;
