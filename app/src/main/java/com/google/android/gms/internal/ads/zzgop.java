...
final class zzgop extends zzgmy implements RandomAccess, zzgqn {
    ...
    private zzgop(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        byte[] bArr = zzgpg.zzd;
        collection.getClass();
        if (collection instanceof zzgop) {
            zzgop zzgopVar = (zzgop) collection;
            int i = zzgopVar.zzc;
            if (i == 0) {
                return false;
            }
            ...
            if (Integer.MAX_VALUE - i2 >= i) {
                ...
                System.arraycopy(zzgopVar.zzb, 0, this.zzb, this.zzc, zzgopVar.zzc);
                this.zzc = i3;
                ((AbstractList) this).modCount++;
                return true;
            }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof zzgop) {
            ...
            if (this.zzc != zzgopVar.zzc) {
                return false;
            }
            float[] fArr = zzgopVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzgpf zzd(int i) {
        if (i >= this.zzc) {
            return new zzgop(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
