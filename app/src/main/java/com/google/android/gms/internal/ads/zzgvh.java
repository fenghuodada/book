...
public final class zzgvh {
    ...
    public zzgvh(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        this.zze = d5;
        this.zzf = d6;
        this.zzg = d7;
        this.zzh = d;
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj == null || zzgvh.class != obj.getClass()) {
            return false;
        }
        zzgvh zzgvhVar = (zzgvh) obj;
        return Double.compare(zzgvhVar.zzh, this.zzh) == 0 && Double.compare(zzgvhVar.zzi, this.zzi) == 0 && Double.compare(zzgvhVar.zzj, this.zzj) == 0 && Double.compare(zzgvhVar.zzk, this.zzk) == 0 && Double.compare(zzgvhVar.zzl, this.zzl) == 0 && Double.compare(zzgvhVar.zzm, this.zzm) == 0 && Double.compare(zzgvhVar.zze, this.zze) == 0 && Double.compare(zzgvhVar.zzf, this.zzf) == 0 && Double.compare(zzgvhVar.zzg, this.zzg) == 0;
    }
