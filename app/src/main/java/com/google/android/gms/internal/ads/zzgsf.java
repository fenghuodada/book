...
public final class zzgsf {
    ...
    */
    public static int zzd(java.lang.CharSequence r7, byte[] r8, int r9, int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgsf.zzd(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    public static String zzg(ByteBuffer byteBuffer, int i, int i2) throws zzgpi {
        zzgsc zzgscVar = zza;
        if (byteBuffer.hasArray()) {
            return zzgscVar.zzb(byteBuffer.array(), byteBuffer.arrayOffset() + i, i2);
        }
        byteBuffer.isDirect();
        return zzgsc.zzd(byteBuffer, i, i2);
    }

    public static String zzh(byte[] bArr, int i, int i2) throws zzgpi {
