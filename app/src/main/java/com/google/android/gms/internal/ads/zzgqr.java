...
interface zzgqr {
    ...
    @Deprecated
    void zzC(List list, zzgqz zzgqzVar, zzgoi zzgoiVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzgqz zzgqzVar, zzgoi zzgoiVar) throws IOException;
    ...
    zzgno zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzgqz zzgqzVar, zzgoi zzgoiVar) throws IOException;

    void zzu(Object obj, zzgqz zzgqzVar, zzgoi zzgoiVar) throws IOException;
