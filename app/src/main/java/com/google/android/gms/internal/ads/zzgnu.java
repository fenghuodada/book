...
public final class zzgnu extends zzgnw {
    ...
    public /* synthetic */ zzgnu(InputStream inputStream, int i, zzgnt zzgntVar) {
        super(null);
    ...
    */
    public final int zzj() throws java.io.IOException {
        ...
        L6d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzgnu.zzj():int");
    }
    ...
    public final zzgno zzw() throws IOException {
        ...
        int i2 = this.zzi;
        if (zzj <= i - i2 && zzj > 0) {
            zzgno zzv = zzgno.zzv(this.zzf, i2, zzj);
            this.zzi += zzj;
            return zzv;
        } else if (zzj != 0) {
            byte[] zzO = zzO(zzj);
            if (zzO != null) {
                return zzgno.zzv(zzO, 0, zzO.length);
            }
            int i3 = this.zzi;
            int i4 = this.zzg;
            int i5 = i4 - i3;
    ...
    public final String zzx() throws IOException {
        ...
        if (zzj > 0) {
            ...
            int i2 = this.zzi;
            if (zzj <= i - i2) {
                String str = new String(this.zzf, i2, zzj, zzgpg.zzb);
                this.zzi += zzj;
                return str;
            }
        }
        ...
        if (zzj <= this.zzg) {
            zzL(zzj);
            String str2 = new String(this.zzf, this.zzi, zzj, zzgpg.zzb);
            this.zzi += zzj;
            return str2;
        }
        return new String(zzN(zzj, false), zzgpg.zzb);
    }
