...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    final int zza;
    @SafeParcelable.Field(getter = "getErrorCode", m4845id = 2)
    private final int zzb;
    @Nullable
    @SafeParcelable.Field(getter = "getResolution", m4845id = 3)
    private final PendingIntent zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getErrorMessage", m4845id = 4)
    ...
    public ConnectionResult(@SafeParcelable.Param(m4844id = 1) int i, @SafeParcelable.Param(m4844id = 2) int i2, @Nullable @SafeParcelable.Param(m4844id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m4844id = 4) String str) {
        this.zza = i;
        this.zzb = i2;
                ...
                switch (i) {
                    ...
                    default:
                        switch (i) {
                            ...
                            default:
                                return C0740h.m11849a("UNKNOWN_ERROR_CODE(", i, ")");
                        }
                }
            }
