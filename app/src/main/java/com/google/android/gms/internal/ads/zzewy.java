...
public final class zzewy implements zzgvo {
    private final zzgwb zza;
    private final zzgwb zzb;
    private final zzgwb zzc;

    public zzewy(zzgwb zzgwbVar, zzgwb zzgwbVar2, zzgwb zzgwbVar3) {
        this.zza = zzgwbVar;
        this.zzb = zzgwbVar2;
        this.zzc = zzgwbVar3;
    }
    ...
    public final zzeww zzb() {
        ...
        if (((Integer) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzgs)).intValue() > 0) {
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzgb)).booleanValue() || z) {
                zzfbz zza = zzfcaVar.zza(zzfbq.AppOpen, context, zzfbiVar, new zzewa(new zzevx()));
