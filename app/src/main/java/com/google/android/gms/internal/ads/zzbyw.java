...
public final class zzbyw {
    ...
    public zzbyw(String str, long j) {
        ...
        try {
            ...
            this.zzh = true;
            this.zzd = this.zzg.optString(AdColonyAdapterUtils.KEY_APP_ID);
                ...
                for (int i = 0; i < optJSONArray2.length(); i++) {
                    ...
                    if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString2)) {
                        if ("interstitial".equalsIgnoreCase(optString)) {
                            ...
                            this.zzc.put(optString2, new zzbnt(optJSONObject3));
                        }
                    }
                }
            }
            ...
            if (((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzgF)).booleanValue() && (optJSONObject2 = this.zzg.optJSONObject("common_settings")) != null && (optJSONArray = optJSONObject2.optJSONArray("loeid")) != null) {
                for (int i3 = 0; i3 < optJSONArray.length(); i3++) {
                    this.zzi.add(optJSONArray.get(i3).toString());
                }
            }
            if (!((Boolean) com.google.android.gms.ads.internal.client.zzba.zzc().zzb(zzbbk.zzga)).booleanValue() || (optJSONObject = this.zzg.optJSONObject("common_settings")) == null) {
                return;
            }
            this.zzj = optJSONObject.optBoolean("is_prefetching_enabled", false);
        } catch (JSONException e) {
            zzbzt.zzk("Exception occurred while processing app setting json", e);
