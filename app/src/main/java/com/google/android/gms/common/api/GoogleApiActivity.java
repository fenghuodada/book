        ...
        if (pendingIntent == null && num == null) {
            ...
            try {
                ...
                if (extras.getBoolean("notify_manager", true)) {
                    ...
                    String m10577a = C1431t.m10577a(new StringBuilder(obj.length() + 36), "Activity not found while launching ", obj, ".");
                    if (Build.FINGERPRINT.contains("generic")) {
                        m10577a = m10577a.concat(" This may occur when resolving Google Play services connection issues on emulators with Google APIs but not Google Play Store.");
                    }
                    Log.e("GoogleApiActivity", m10577a, e);
                }
                this.zaa = 1;
                finish();
