...
public final class zzc extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getLaunchIntentListenerAsBinder", m4845id = 10, type = "android.os.IBinder")
    ...
    public zzc(@SafeParcelable.Param(m4844id = 2) String str, @SafeParcelable.Param(m4844id = 3) String str2, @SafeParcelable.Param(m4844id = 4) String str3, @SafeParcelable.Param(m4844id = 5) String str4, @SafeParcelable.Param(m4844id = 6) String str5, @SafeParcelable.Param(m4844id = 7) String str6, @SafeParcelable.Param(m4844id = 8) String str7, @SafeParcelable.Param(m4844id = 9) Intent intent, @SafeParcelable.Param(m4844id = 10) IBinder iBinder, @SafeParcelable.Param(m4844id = 11) boolean z) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = str3;
        this.zzd = str4;
