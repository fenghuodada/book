...
public final class zzajh implements zzaju {
    ...
    public final void zza(zzfd zzfdVar, int i) {
        ...
        while (zzfdVar.zza() > 0) {
            ...
            if (i3 < 3) {
                ...
                int min2 = Math.min(zzfdVar.zza(), this.zzc - i3);
                ...
                if (i6 != i7) {
                    ...
                    if (!this.zze) {
                        this.zzb.zzE(i7);
                    } else if (zzfn.zzd(this.zzb.zzH(), 0, i7, -1) != 0) {
                        this.zzf = true;
                        return;
                    } else {
    ...
    public final void zzb(zzfl zzflVar, zzaar zzaarVar, zzajt zzajtVar) {
        this.zza.zzb(zzflVar, zzaarVar, zzajtVar);
        this.zzf = true;
    }
