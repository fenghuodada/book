...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    final int zzb;
    @SafeParcelable.Field(getter = "getStatusCode", m4845id = 1)
    private final int zzc;
    @Nullable
    @SafeParcelable.Field(getter = "getStatusMessage", m4845id = 2)
    private final String zzd;
    @Nullable
    @SafeParcelable.Field(getter = "getPendingIntent", m4845id = 3)
    private final PendingIntent zze;
    @Nullable
    @SafeParcelable.Field(getter = "getConnectionResult", m4845id = 4)
    ...
    public Status(@SafeParcelable.Param(m4844id = 1000) int i, @SafeParcelable.Param(m4844id = 1) int i2, @Nullable @SafeParcelable.Param(m4844id = 2) String str, @Nullable @SafeParcelable.Param(m4844id = 3) PendingIntent pendingIntent, @Nullable @SafeParcelable.Param(m4844id = 4) ConnectionResult connectionResult) {
        this.zzb = i;
        this.zzc = i2;
        this.zzd = str;
