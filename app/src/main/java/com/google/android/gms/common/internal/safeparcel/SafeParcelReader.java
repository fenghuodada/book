...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(@NonNull Parcel parcel, int i) {
        ...
        throw new ParseException(C0235r.m12816a("Overread allowed size end=", i), parcel);
    }
    ...
    public static int validateObjectHeader(@NonNull Parcel parcel) {
        ...
        if (fieldId == 20293) {
            ...
            throw new ParseException(C1194j.m11060a("Size read is invalid start=", dataPosition, " end=", i), parcel);
        }
    ...
    private static void zza(Parcel parcel, int i, int i2, int i3) {
        ...
        throw new ParseException(C0484a.m12392a(C1169e.m11130b("Expected size ", i3, " got ", i2, " (0x"), Integer.toHexString(i2), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i2) {
        ...
        throw new ParseException(C0484a.m12392a(C1169e.m11130b("Expected size ", i2, " got ", readSize, " (0x"), Integer.toHexString(readSize), ")"), parcel);
    }
}
