...
public final class zzko {
    ...
    public final void zzc(long j, boolean z) {
        ...
        if (this.zza.zzt.zzJ()) {
            ...
            this.zza.zzt.zzq().zzY(V2rayConfig.DEFAULT_SECURITY, "_sid", valueOf, j);
            ...
            this.zza.zzt.zzq().zzH(V2rayConfig.DEFAULT_SECURITY, "_s", j, bundle);
            zzos.zzc();
            if (this.zza.zzt.zzf().zzs(null, zzeg.zzae)) {
                ...
                this.zza.zzt.zzq().zzH(V2rayConfig.DEFAULT_SECURITY, "_ssr", j, bundle2);
            }
        }
    }
}
