...
import com.facebook.ads.redexgen.p036X.C4523AG;
import com.facebook.ads.redexgen.p036X.C4645CF;
import com.facebook.ads.redexgen.p036X.C4646CG;
...
public final class DrmInitData implements Comparator<SchemeData>, Parcelable {
    ...
    public static final Parcelable.Creator<DrmInitData> CREATOR = new C4645CF();
    public int A00;
    ...
    public static final class SchemeData implements Parcelable {
        ...
        public static final Parcelable.Creator<SchemeData> CREATOR = new C4646CG();
        public int A00;
        @Nullable
        ...
        public SchemeData(UUID uuid, @Nullable String str, String str2, byte[] bArr, boolean z) {
            this.A05 = (UUID) C4997IK.A01(uuid);
            this.A01 = str;
            this.A02 = (String) C4997IK.A01(str2);
            this.A04 = bArr;
            this.A03 = z;
        }
        ...
        public final boolean A02(UUID uuid) {
            return C4523AG.A04.equals(this.A05) || uuid.equals(this.A05);
        }
        ...
        public final boolean equals(@Nullable Object obj) {
            if (obj instanceof SchemeData) {
                ...
                if (C5038Iz.A0g(this.A01, schemeData.A01) && C5038Iz.A0g(this.A02, schemeData.A02) && C5038Iz.A0g(this.A05, schemeData.A05) && Arrays.equals(this.A04, schemeData.A04)) {
                    return true;
                }
                return false;
            }
    ...
    public final int compare(SchemeData schemeData, SchemeData schemeData2) {
        if (!C4523AG.A04.equals(schemeData.A05)) {
            return schemeData.A05.compareTo(schemeData2.A05);
        }
        UUID uuid = C4523AG.A04;
        String[] strArr = A04;
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (C5038Iz.A0g(this.A02, drmInitData.A02) && Arrays.equals(this.A03, drmInitData.A03)) {
            return true;
        }
        return false;
    }
