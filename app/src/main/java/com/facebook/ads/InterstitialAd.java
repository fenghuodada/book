...
public class InterstitialAd implements FullScreenAd {
    ...
    @Keep
    /* loaded from: classes.dex */
    public interface InterstitialAdLoadConfigBuilder extends InterfaceC3877Ad.LoadConfigBuilder {
    ...
    @Keep
    /* loaded from: classes.dex */
    public interface InterstitialLoadAdConfig extends InterfaceC3877Ad.LoadAdConfig {
    }
