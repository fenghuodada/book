...
public final class C5693Tj implements InterfaceC5251MY {
    ...
    */
    public static void A00(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.p036X.C5693Tj.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f) {
        ...
        try {
            ...
            for (int i2 = 0; i2 < i; i2++) {
                int i3 = height;
                arrayList.add(new CallableC5255Mc(currentPixels, cores, i3, (int) f, i, i2, 1));
                height = i3;
                arrayList2.add(new CallableC5255Mc(currentPixels, cores, height, (int) f, i, i2, 2));
            }
            try {
                C5256Md.A01.invokeAll(arrayList);
                try {
                    C5256Md.A01.invokeAll(arrayList2);
                    try {
