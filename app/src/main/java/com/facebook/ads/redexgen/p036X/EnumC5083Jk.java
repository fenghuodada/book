...
public enum EnumC5083Jk {
    ...
    EnumC5083Jk(String str) {
        this.A00 = str;
    }

    public static EnumC5083Jk A00(String str) {
        EnumC5083Jk[] values;
        for (EnumC5083Jk enumC5083Jk : values()) {
            if (enumC5083Jk.A00.equalsIgnoreCase(str)) {
                return enumC5083Jk;
            }
        }
        String[] strArr = A02;
