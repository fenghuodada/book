...
public class RunnableC4835Fe implements Runnable {
    ...
    public RunnableC4835Fe(C4842Fl c4842Fl, InterfaceC4845Fo interfaceC4845Fo, C4843Fm c4843Fm, C4844Fn c4844Fn) {
        this.A00 = c4842Fl;
