...
public final class C44699O {
    ...
    public static long A01(C44148U c44148u) {
        try {
            PackageManager packageManager = c44148u.getPackageManager();
            if (packageManager == null) {
                return -1L;
            }
            return new File(packageManager.getApplicationInfo(c44148u.getPackageName(), 0).publicSourceDir).length();
        } catch (Exception e) {
            if (A03.compareAndSet(false, true)) {
                c44148u.A06().A8y(A02(144, 7, 117), C44458z.A1E, new C444690(e));
            }
            return -1L;
        }
    }
    ...
    public static String A05(C44148U c44148u) {
        ...
        A07(c44148u, jSONObject, A02(174, 6, 127), String.valueOf(A08()));
        A07(c44148u, jSONObject, A02(97, 8, 52), String.valueOf(A01(c44148u)));
        A07(c44148u, jSONObject, A02(180, 15, 73), String.valueOf(A00()));
        A07(c44148u, jSONObject, A02(105, 18, 113), String.valueOf(C5175LI.A01(c44148u)));
        A07(c44148u, jSONObject, A02(161, 13, 111), String.valueOf(A09(c44148u)));
        A07(c44148u, jSONObject, A02(133, 11, 61), A04(c44148u));
        A07(c44148u, jSONObject, A02(123, 10, 96), A03(c44148u));
        return jSONObject.toString();
    }

    public static void A07(C44148U c44148u, JSONObject jSONObject, String str, @Nullable String str2) {
        try {
