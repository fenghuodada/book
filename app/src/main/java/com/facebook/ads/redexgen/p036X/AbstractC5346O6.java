...
public abstract class AbstractC5346O6 extends WebView {
    ...
    static {
        A01();
        A03 = AbstractC5346O6.class.getSimpleName();
    }

    public AbstractC5346O6(Activity activity, C5953Xy c5953Xy) {
        super(activity);
        A03(c5953Xy);
    }

    public AbstractC5346O6(C5953Xy c5953Xy) {
        super(c5953Xy);
        A03(c5953Xy);
    }
    ...
    public static void A02(int i) {
        ...
        if (A00 != null) {
            A00.A06().A8y(A00(56, 8, 76), i, new C444690(A00(35, 10, 98)));
        }
    }

    private void A03(C44148U c44148u) {
        ...
        if (c44148u.A03().A8P() && Build.VERSION.SDK_INT >= 19) {
