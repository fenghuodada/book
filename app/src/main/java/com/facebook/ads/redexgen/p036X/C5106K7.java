...
public final class C5106K7 implements NativeAdViewAttributesApi {
    public static final int A08 = (int) (C5208Lr.A00 * 4.0f);
    public static final int A07 = (int) (C5208Lr.A00 * 1.0f);
    ...
    public final int A04(float f) {
        int i = this.A01;
        return C40592U.A02(((-16777216) & i) | ((i ^ (-1)) & 16777215), i, f);
    }
    ...
    public final void A05(TextView textView) {
        ...
        C5245MS.A0S(textView, stateListDrawable);
