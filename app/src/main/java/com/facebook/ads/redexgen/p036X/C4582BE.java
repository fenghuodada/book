...
public final class C4582BE {
    public static byte[] A02;
    public static final C4582BE A03;
    ...
    static {
        A03();
        A03 = new C4582BE(new int[]{2}, 2);
    }

    public C4582BE(int[] iArr, int i) {
        if (iArr != null) {
    ...
    public static C4582BE A00(Context context) {
        return A01(context.registerReceiver(null, new IntentFilter(A02(56, 36, 98))));
    }

    @SuppressLint({"InlinedApi"})
    public static C4582BE A01(Intent intent) {
        if (intent == null || intent.getIntExtra(A02(92, 36, 85), 0) == 0) {
            return A03;
        }
        return new C4582BE(intent.getIntArrayExtra(A02(128, 29, 70)), intent.getIntExtra(A02(157, 37, 92), 0));
    }
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (obj instanceof C4582BE) {
            C4582BE audioCapabilities = (C4582BE) obj;
