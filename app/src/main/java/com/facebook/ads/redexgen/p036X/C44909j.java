...
public final class C44909j {
    ...
    public final int A04(C44909j c44909j) {
        int i = this.A00;
        int i2 = c44909j.A00;
        if (i != i2) {
            return i - i2;
        }
        return this.A01 - c44909j.A01;
    }

    public final C44909j A05(int i) {
        int i2 = this.A01;
        if (i + i2 >= 0) {
            return new C44909j(this.A00, i2 + i);
        }
        throw new IllegalArgumentException(String.format(Locale.US, A00(0, 35, 63), Integer.valueOf(i), Integer.valueOf(this.A01)));
    }

    public final boolean equals(Object obj) {
        if (obj instanceof C44909j) {
            C44909j c44909j = (C44909j) obj;
            int i = c44909j.A00;
            int i2 = this.A00;
            if (A03[4].charAt(2) != 'U') {
            ...
            return i == i2 && c44909j.A01 == this.A01;
        }
        return false;
    }
