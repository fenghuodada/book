...
public final class C5038Iz {
    ...
    public static long A0I(long maxPositionUs, C4565Ax c4565Ax, long j, long j2) {
        if (C4565Ax.A04.equals(c4565Ax)) {
            return maxPositionUs;
        }
        long A0H = A0H(maxPositionUs, c4565Ax.A01, Long.MIN_VALUE);
        long A0G = A0G(maxPositionUs, c4565Ax.A00, Long.MAX_VALUE);
        boolean z = true;
        boolean z2 = A0H <= j && j <= A0G;
        z = (A0H > j2 || j2 > A0G) ? false : false;
        if (z2 && z) {
    ...
    public static String A0O(String str) {
        ...
        while (i > 0 && matcher.find()) {
            ...
            sb.append((CharSequence) str, i4, startOfNotEscaped2);
            sb.append(c);
            i4 = matcher.end();
            i--;
        }
    ...
    public static ExecutorService A0T(String str) {
        return Executors.newSingleThreadExecutor(new ThreadFactoryC5037Iy(str));
    }
    ...
    public static void A0W(InterfaceC4955He interfaceC4955He) {
    ...
    */
    public static byte[] A0h(java.lang.String r6) {
        ...
        L2b:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.p036X.C5038Iz.A0h(java.lang.String):byte[]");
    }
