...
public enum EnumC5553RS {
    A09(A00(145, 13, 65), EnumC5555RU.A02, true),
    A08(A00(128, 17, 7), EnumC5555RU.A03, true),
    A07(A00(114, 14, 69), EnumC5555RU.A03, false),
    A0A(A00(171, 23, 11), EnumC5555RU.A03, false),
    A0B(A00(158, 13, 70), EnumC5555RU.A03, true),
    A06(A00(97, 17, 110), EnumC5555RU.A03, false);
    ...
    EnumC5553RS(String str, EnumC5555RU enumC5555RU, boolean z) {
        this.A01 = str;
        this.A00 = enumC5555RU;
        this.A02 = z;
    }

    public final EnumC5555RU A02() {
        return this.A00;
    }
