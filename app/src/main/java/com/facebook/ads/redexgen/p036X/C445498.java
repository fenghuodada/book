...
public final class C445498 {
    ...
    public static void A0A(C44148U c44148u) {
        try {
            c44148u = c44148u.registerReceiver(null, new IntentFilter(A01(24, 37, 122)));
            if (c44148u == 0) {
                return;
            }
            int intExtra = c44148u.getIntExtra(A01(109, 5, 89), -1);
            int status = c44148u.getIntExtra(A01(123, 5, 3), -1);
            int scale = c44148u.getIntExtra(A01(134, 6, 71), -1);
            ...
            c44148u.A06().A8y(A01(102, 7, 57), C44458z.A1T, new C444690(e));
        }
    }

    public static synchronized void A0B(C44148U c44148u) {
        synchronized (C445498.class) {
            A09(c44148u);
            A0A(c44148u);
            if (A04 == null) {
                A04 = (SensorManager) c44148u.getSystemService(A01(128, 6, 67));
                if (A04 == null) {
                    return;
                }
            }
