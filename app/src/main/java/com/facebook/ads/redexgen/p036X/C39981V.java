...
public final class C39981V {
    ...
    public static C39941R A00(JSONObject jSONObject) {
        return new C39931Q().A06(A06(jSONObject)).A07(A05(jSONObject)).A05(A07(jSONObject)).A04(A04(jSONObject)).A08();
    }

    public static C40041b A01(JSONObject jSONObject) {
        return new C40031a().A02(A08(jSONObject)).A03(A09(jSONObject)).A04();
    }
