...
import com.facebook.ads.redexgen.p036X.C39530m;
...
public final class C39530m {
    ...
    public final InterfaceC5080Jh A05;
    public long A00 = 0;
    @Nullable
    public String A04 = null;
    @Nullable
    public EnumC39460e A02 = null;
    ...
    public C39530m(InterfaceC5080Jh interfaceC5080Jh, final Activity activity, int i) {
        this.A05 = interfaceC5080Jh;
    ...
    @Nullable
    public static C39530m A00(InterfaceC5080Jh interfaceC5080Jh, @Nullable Activity activity) {
        return A01(interfaceC5080Jh, activity, Build.VERSION.SDK_INT);
    }

    @Nullable
    @VisibleForTesting
    public static C39530m A01(InterfaceC5080Jh interfaceC5080Jh, @Nullable Activity activity, int i) {
        if (activity != null && i >= 14) {
            return new C39530m(interfaceC5080Jh, activity, i);
        }
        return null;
    }

    private void A04(String str, long j, long j2, @Nullable EnumC39460e enumC39460e) {
        HashMap hashMap = new HashMap();
        hashMap.put(A02(9, 10, 8), Long.toString(j));
        hashMap.put(A02(0, 9, 34), Long.toString(j2));
        if (enumC39460e != null) {
            hashMap.put(A02(19, 7, 9), enumC39460e.name());
        }
    ...
    public final void A06(@Nullable EnumC39460e enumC39460e) {
        this.A02 = enumC39460e;
    }
    ...
    public final void A07(String str) {
        ...
        EnumC39460e enumC39460e = EnumC39460e.A03;
        if (A07[2].charAt(6) == '9') {
