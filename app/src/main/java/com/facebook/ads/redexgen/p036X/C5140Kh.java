...
public final class C5140Kh {
    ...
    public C5140Kh(C44148U c44148u, String str, @Nullable C5221M4 c5221m4, EnumC5119KM enumC5119KM, @Nullable String str2, int i, boolean z, boolean z2, C5124KR c5124kr, @Nullable String str3, @Nullable String str4, @Nullable String str5) {
        this.A01 = c44148u;
        this.A06 = str;
        this.A03 = c5221m4;
        this.A02 = enumC5119KM;
        this.A0D = str2;
        this.A00 = i;
        this.A0A = z;
        this.A08 = z2;
        this.A0C = c5124kr;
        this.A0B = enumC5119KM.A04();
        this.A07 = str3;
        this.A05 = str4;
        this.A04 = str5;
    }
    ...
    private long A00() {
        SharedPreferences A00 = C5151Kt.A00(this.A01);
        ...
        if (string.equals(locale)) {
            return C40432E.A00(this.A01.A00()).A09();
        }
    ...
    public final EnumC5119KM A05() {
        return this.A02;
    }

    @Nullable
    public final C5221M4 A06() {
        return this.A03;
    }
    ...
    public final Map<String, String> A08(Map<String, String> map) {
        ...
        A03(hashMap, A01(125, 4, 91), C42665s.A00().A03());
        if (C42665s.A00().A04()) {
            A01 = A01(0, 1, 52);
        } else {
            A01 = A01(1, 1, 52);
        ...
        C5221M4 c5221m4 = this.A03;
        if (c5221m4 != null) {
            A03(hashMap, A01(276, 5, 52), String.valueOf(c5221m4.A01()));
            A03(hashMap, A01(119, 6, 81), String.valueOf(this.A03.A00()));
        }
        EnumC5119KM enumC5119KM = this.A02;
        if (enumC5119KM != null) {
            A03(hashMap, A01(256, 11, 36), String.valueOf(enumC5119KM.A03()));
        }
        boolean z = this.A0A;
        String[] strArr = A0F;
        if (strArr[1].charAt(22) == strArr[3].charAt(22)) {
            ...
            A03(hashMap, A01(160, 13, 80), String.valueOf(C5246MT.A02(this.A01)));
            A03(hashMap, A01(233, 12, 126), C5236MJ.A05(System.currentTimeMillis()));
            ...
            A03(hashMap, A01(20, 36, 122), C5236MJ.A06(A00()));
