...
public enum EnumC5213Lw {
    ...
    EnumC5213Lw(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    public static EnumC5213Lw A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC5213Lw[] values;
        for (EnumC5213Lw enumC5213Lw : values()) {
            if (enumC5213Lw.A01 == nativeComponentTag) {
                return enumC5213Lw;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC5213Lw A00 = A00(nativeComponentTag);
        if (view != null && A00 != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC5213Lw enumC5213Lw) {
        if (view != null && enumC5213Lw != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC5213Lw);
        }
    }
