...
public enum EnumC5195Le {
    ...
    public static final EnumC5195Le[] A02;
    ...
    static {
        A03();
        A02 = new EnumC5195Le[]{A0G, A08, A05, A0E, A0H, A0I, A0B, A0A};
        JSONArray jSONArray = new JSONArray();
        for (EnumC5195Le enumC5195Le : A02) {
            jSONArray.put(enumC5195Le.A00());
        }
