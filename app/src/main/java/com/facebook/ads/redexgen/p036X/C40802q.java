...
public final class C40802q {
    ...
    public C40802q(@NonNull View view) {
        this.A04 = view;
    }
    ...
    public final boolean A07(float f, float f2) {
        ...
        return C41133O.A06(A00, this.A04, f, f2);
    }
    ...
    public final boolean A08(float f, float f2, boolean z) {
        ...
        return C41133O.A07(A00, this.A04, f, f2, z);
    }
        ...
        if (A06()) {
            if (A05[0].charAt(13) != 't') {
                ...
                for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                    if (C41133O.A08(parent, view, this.A04, i, i2)) {
                        A01(i2, parent);
                        C41133O.A05(parent, view, this.A04, i, i2);
                        return true;
                    }
    ...
    public final boolean A0D(int i, int i2, int i3, int i4, @Nullable int[] iArr, int i5) {
        ...
        if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
            ...
            C41133O.A03(A00, this.A04, i, i2, i3, i4, i5);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
    ...
    */
    public final boolean A0F(int r17, int r18, @androidx.annotation.Nullable int[] r19, @androidx.annotation.Nullable int[] r20, int r21) {
        ...
        L20:
            r7 = 0
            r6 = 0
            java.lang.String[] r1 = com.facebook.ads.redexgen.p036X.C40802q.A05
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
            if (r1 == r0) goto L9b
            java.lang.String[] r2 = com.facebook.ads.redexgen.p036X.C40802q.A05
        ...
        L67:
            ...
            com.facebook.ads.redexgen.p036X.C41133O.A04(r10, r11, r12, r13, r14, r15)
            if (r3 == 0) goto L81
            android.view.View r0 = r4.A04
            r0.getLocationInWindow(r3)
            r0 = r3[r9]
        ...
        La7:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.p036X.C40802q.A0F(int, int, int[], int[], int):boolean");
    }
}
