...
public final class C5967YC extends AbstractC43457A<Float> {
    ...
    public C5967YC(long j, @Nullable C434378 c434378, float f) {
        super(j, c434378, Float.valueOf(f), EnumC434479.A05);
    }
    ...
    @Override // com.facebook.ads.redexgen.p036X.AbstractC43457A
    public final boolean A0A(AbstractC43457A<Float> abstractC43457A) {
        return Math.abs(A07().floatValue() - abstractC43457A.A07().floatValue()) < C42856C.A01();
    }
}
