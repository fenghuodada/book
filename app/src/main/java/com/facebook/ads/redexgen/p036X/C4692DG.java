...
public final class C4692DG {
    ...
    public static Metadata.Entry A01(C5022Ij c5022Ij) {
        int typeTopByte = c5022Ij.A08() + c5022Ij.A06();
        int shortType = c5022Ij.A08();
        ...
        try {
                    ...
                    if (i2 != endPosition4) {
                        ...
                        if (i2 != endPosition5) {
                            ...
                            if (i2 != endPosition6) {
                                ...
                                if (i2 == endPosition7) {
                                    return A07(shortType, A09(1445, 4, 90), c5022Ij);
                                }
                                int endPosition8 = A03;
                                if (i2 == endPosition8) {
                                    return A07(shortType, A09(1457, 4, 37), c5022Ij);
                                }
                                int endPosition9 = A07;
                                if (i2 == endPosition9) {
                                    return A07(shortType, A09(1493, 4, 47), c5022Ij);
                                }
                                int endPosition10 = A02;
                                if (i2 == endPosition10) {
                                    return A07(shortType, A09(1425, 4, 51), c5022Ij);
                                }
                                int endPosition11 = A09;
                                if (i2 == endPosition11) {
                                    return A07(shortType, A09(1592, 4, 27), c5022Ij);
                                }
                                int endPosition12 = A08;
                                if (i2 == endPosition12) {
                                    return A07(shortType, A09(1441, 4, 121), c5022Ij);
                                }
                                int endPosition13 = A0J;
                                if (i2 == endPosition13) {
                                    return A07(shortType, A09(1449, 4, 57), c5022Ij);
                                }
                            }
                        }
                        return A07(shortType, A09(1437, 4, 105), c5022Ij);
                    }
                }
                TextInformationFrame A072 = A07(shortType, A09(1453, 4, 67), c5022Ij);
                c5022Ij.A0Y(typeTopByte);
                if (A01[3].charAt(3) != 'b') {
                    String[] strArr = A01;
            ...
            if (shortType == endPosition14) {
                TextInformationFrame A082 = A08(c5022Ij);
                c5022Ij.A0Y(typeTopByte);
                String[] strArr2 = A01;
            ...
            if (shortType == endPosition16) {
                return A06(shortType, A09(1465, 4, 120), c5022Ij);
            }
            int endPosition17 = A0S;
            if (shortType == endPosition17) {
                return A06(shortType, A09(1469, 4, 7), c5022Ij);
            }
            int endPosition18 = A0R;
            if (shortType == endPosition18) {
                return A04(shortType, A09(1429, 4, 15), c5022Ij, true, false);
            }
            int endPosition19 = A0E;
            if (shortType == endPosition19) {
                return A04(shortType, A09(1433, 4, 84), c5022Ij, true, true);
            }
            ...
            if (shortType == endPosition21) {
                return A07(shortType, A09(1461, 4, 56), c5022Ij);
            }
            int endPosition22 = A0Q;
            if (shortType == endPosition22) {
                return A07(shortType, A09(1489, 4, 17), c5022Ij);
            }
            int endPosition23 = A0M;
            if (shortType == endPosition23) {
                return A07(shortType, A09(1473, 4, 6), c5022Ij);
            }
            int endPosition24 = A0O;
            if (shortType == endPosition24) {
                return A07(shortType, A09(1477, 4, 14), c5022Ij);
            }
            int endPosition25 = A0N;
            if (shortType == endPosition25) {
                return A07(shortType, A09(1485, 4, 121), c5022Ij);
            }
            int endPosition26 = A0P;
            if (shortType == endPosition26) {
                return A07(shortType, A09(1481, 4, 102), c5022Ij);
            }
            int endPosition27 = A0L;
            if (shortType == endPosition27) {
                return A04(shortType, A09(843, 14, 87), c5022Ij, false, false);
            }
            int endPosition28 = A0H;
            if (shortType == endPosition28) {
                return A04(shortType, A09(857, 13, 92), c5022Ij, false, true);
            }
            int endPosition29 = A0U;
            if (shortType == endPosition29) {
                return A07(shortType, A09(1503, 10, 78), c5022Ij);
            }
            int endPosition30 = A0T;
            if (shortType == endPosition30) {
                return A07(shortType, A09(1497, 6, 69), c5022Ij);
            }
            int endPosition31 = A0K;
            if (shortType == endPosition31) {
                return A05(c5022Ij, typeTopByte);
            }
            String str3 = A09(1287, 32, 3) + AbstractC4680D3.A02(shortType);
            return null;
        } finally {
            c5022Ij.A0Y(typeTopByte);
        }
    ...
    public static ApicFrame A02(C5022Ij c5022Ij) {
        String A092;
        int atomType = c5022Ij.A08();
        int A082 = c5022Ij.A08();
        int i = AbstractC4680D3.A0F;
        ...
        int fullVersionInt = AbstractC4680D3.A00(c5022Ij.A08());
    ...
    public static CommentFrame A03(int atomSize, C5022Ij c5022Ij) {
        int A082 = c5022Ij.A08();
        if (c5022Ij.A08() == AbstractC4680D3.A0F) {
            c5022Ij.A0Z(8);
            String A0R2 = c5022Ij.A0R(A082 - 16);
            return new CommentFrame(A09(1744, 3, 3), A0R2, A0R2);
        }
        Log.w(A09(981, 12, 3), A09(457, 35, 20) + AbstractC4680D3.A02(atomSize));
        return null;
    }

    public static Id3Frame A04(int value, String str, C5022Ij c5022Ij, boolean z, boolean z2) {
        ...
        Log.w(A09(981, 12, 3), A09(670, 33, 84) + AbstractC4680D3.A02(value));
        return null;
    }

    public static Id3Frame A05(C5022Ij c5022Ij, int i) {
        String str = null;
        String str2 = null;
        int atomPosition = -1;
        int atomSize = -1;
        while (c5022Ij.A06() < i) {
            ...
            c5022Ij.A0Z(4);
            int atomType = AbstractC4680D3.A0e;
            if (A083 == atomType) {
                int atomType2 = A082 - 12;
                str = c5022Ij.A0R(atomType2);
            } else {
                int atomType3 = AbstractC4680D3.A0o;
                if (A083 == atomType3) {
                    int atomType4 = A082 - 12;
                    str2 = c5022Ij.A0R(atomType4);
                } else {
                    int atomType5 = AbstractC4680D3.A0F;
                    if (A083 == atomType5) {
                        atomPosition = A062;
                        atomSize = A082;
                    }
                    int atomType6 = A082 - 12;
                    c5022Ij.A0Z(atomType6);
                }
            }
        }
        ...
        c5022Ij.A0Y(atomPosition);
        c5022Ij.A0Z(16);
        int atomType7 = atomSize - 16;
        return new InternalFrame(str, str2, c5022Ij.A0R(atomType7));
    }

    public static TextInformationFrame A06(int atomSize, String str, C5022Ij c5022Ij) {
        int A082 = c5022Ij.A08();
        if (c5022Ij.A08() == AbstractC4680D3.A0F && A082 >= 22) {
            c5022Ij.A0Z(10);
        ...
        Log.w(A09(981, 12, 3), A09(527, 39, 49) + AbstractC4680D3.A02(atomSize));
        return null;
    }

    public static TextInformationFrame A07(int atomSize, String str, C5022Ij c5022Ij) {
        int A082 = c5022Ij.A08();
        if (c5022Ij.A08() == AbstractC4680D3.A0F) {
            c5022Ij.A0Z(8);
            return new TextInformationFrame(str, null, c5022Ij.A0R(A082 - 16));
        }
        Log.w(A09(981, 12, 3), A09(601, 32, 115) + AbstractC4680D3.A02(atomSize));
        return null;
    }
    ...
    */
    public static com.facebook.ads.internal.exoplayer2.metadata.id3.TextInformationFrame A08(com.facebook.ads.redexgen.p036X.C5022Ij r4) {
        /*
            int r2 = A00(r4)
            r4 = 0
            if (r2 <= 0) goto L21
            java.lang.String[] r1 = com.facebook.ads.redexgen.p036X.C4692DG.A0V
            int r0 = r1.length
            if (r2 > r0) goto L21
            int r0 = r2 + (-1)
            r3 = r1[r0]
        ...
        L23:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.p036X.C4692DG.A08(com.facebook.ads.redexgen.X.Ij):com.facebook.ads.internal.exoplayer2.metadata.id3.TextInformationFrame");
    }
}
