...
public final class C40452G {
    ...
    public static void A01() {
        A03 = new byte[]{106, 120, 66, 73, 67, 29, 17, 30, 17, 23, 21, 47, 17, 20, 47, 0, 2, 21, 22, 21, 2, 21, 30, 19, 21, 3, 60, 35, 39, 58, 60, 61, 32, 12, 32, 54, Utf8.REPLACEMENT_BYTE, 54, 48, 39, 54, 55, 52, 51, 38, 53, 51, 100, 98, 116, 99, 78, 123, 126, 100, 99, Byte.MAX_VALUE, 116, 104, 70, 89, 72, 110, 80, 92, 110, 88, 110, 66, 84, 84, 88, 95, 86, 110, 69, 89, 88, 66};
    }
    ...
    public C40452G(C5088Jp c5088Jp) {
        this.A00 = c5088Jp;
    }
    ...
    public final void A04() {
        ...
        C5088Jp c5088Jp = this.A00;
        if (c5088Jp != null) {
            c5088Jp.A02(EnumC5087Jo.A0B, null);
        }
    }
    ...
    public final void A06() {
        ...
        C5088Jp c5088Jp = this.A00;
        if (c5088Jp != null) {
            c5088Jp.A02(EnumC5087Jo.A0C, null);
        }
    }
    ...
    public final void A08(EnumC40442F enumC40442F) {
        List<String> list = this.A02;
        list.add(enumC40442F.A02() + A00(1, 4, 96));
        C5088Jp c5088Jp = this.A00;
        if (c5088Jp != null) {
            c5088Jp.A02(EnumC5087Jo.A09, null);
        }
    }

    public final void A09(EnumC40442F enumC40442F, int i) {
        List<String> list = this.A02;
        list.add(enumC40442F.A02() + A00(0, 1, 114) + i);
    }
