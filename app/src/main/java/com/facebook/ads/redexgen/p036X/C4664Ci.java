...
public final class C4664Ci {
    ...
    public static boolean A04(int version, C4664Ci c4664Ci) {
        int i;
        int bitrate;
        int bitrateIndex;
        int i2;
        ...
        c4664Ci.A03(i, str, i4, samplesPerFrame, (frameSize2 & 3) == 3 ? 1 : 2, bitrateIndex2 * 1000, i3);
        return true;
    }
}
