...
public enum EnumC5420PJ {
    ...
    EnumC5420PJ(String str) {
        this.A00 = str;
    }

    public static EnumC5420PJ A00(String str) {
        EnumC5420PJ[] values;
        for (EnumC5420PJ enumC5420PJ : values()) {
            if (enumC5420PJ.A00.equalsIgnoreCase(str)) {
                return enumC5420PJ;
            }
        }
        return A0O;
