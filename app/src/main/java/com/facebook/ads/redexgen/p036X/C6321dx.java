...
public final class C6321dx implements InterfaceC39260K {
    ...
    static {
        A04();
        A07 = C6321dx.class.getSimpleName();
    }

    public C6321dx(String str) {
        this(str, C39240I.A01(str));
    }

    public C6321dx(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C6321dx(String str, @Nullable String str2) {
        this.A05 = Integer.MIN_VALUE;
        this.A00 = -1;
        this.A03 = (String) C39250J.A00(str);
        this.A06 = str2;
    }
    ...
    private HttpURLConnection A02(int i, int i2) throws IOException, C6323dz {
        String A01;
        ...
        do {
            ...
            if (code > 5) {
                throw new C6323dz(A01(293, 20, 106) + code);
            }
        } while (z);
        return httpURLConnection;
    }

    private void A03() throws C6323dz {
    ...
    private final void A05(int i, int i2) throws C6323dz {
        try {
            this.A02 = A02(i, i2);
            ...
            throw new C6323dz(A01(154, 29, 63) + this.A03 + A01(19, 13, 86) + i, e);
        }
    }
    ...
    public final void close() throws C6323dz {
        ...
        if (httpURLConnection != null) {
            try {
                ...
                throw new C6323dz(A01(92, 37, 93), e);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.p036X.InterfaceC39260K
    public final synchronized int length() throws C6323dz {
    ...
    public final int read(byte[] bArr) throws C6323dz {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C4873GI(A01(278, 15, 96) + this.A03 + A01(0, 15, 66), e);
            } catch (IOException e2) {
                throw new C6323dz(A01 + this.A03, e2);
            }
        }
        throw new C6323dz(A01 + this.A03 + A01(51, 23, 21));
    }
