...
public final class Choreographer$FrameCallbackC5049JC implements Choreographer.FrameCallback, Handler.Callback {
    ...
    public static final Choreographer$FrameCallbackC5049JC A07;
    public int A00;
    ...
    static {
        A05();
        A07 = new Choreographer$FrameCallbackC5049JC();
    }

    public Choreographer$FrameCallbackC5049JC() {
        this.A03.start();
        this.A02 = new Handler(this.A03.getLooper(), this);
        this.A02.sendEmptyMessage(0);
    }

    public static Choreographer$FrameCallbackC5049JC A00() {
        return A07;
    }
