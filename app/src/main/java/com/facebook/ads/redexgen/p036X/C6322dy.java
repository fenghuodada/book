...
public final class C6322dy implements InterfaceC39220G {
    public static byte[] A03;
    public File A00;
    public RandomAccessFile A01;
    public final InterfaceC39170B A02;
    ...
    public C6322dy(File file, InterfaceC39170B interfaceC39170B) throws C6320dw {
        File file2;
        try {
            if (interfaceC39170B != null) {
                this.A02 = interfaceC39170B;
                C39200E.A06(file.getParentFile());
            ...
            throw new C6320dw(A00(186, 17, 126) + file + A00(0, 14, 84), e);
        }
    }
    ...
    public final synchronized int A03() throws C6320dw {
        try {
        } catch (IOException e) {
            throw new C6320dw(A00(137, 29, 81) + this.A00, e);
        }
    ...
    public final synchronized void A05() throws C6320dw {
        try {
            this.A01.setLength(0L);
        } catch (IOException e) {
            throw new C6320dw(A00(57, 16, 6), e);
        }
    }

    public final synchronized void A06() throws C6320dw {
        try {
            this.A01.close();
            this.A02.AFC(this.A00);
        } catch (IOException e) {
            throw new C6320dw(A00(104, 19, 99) + this.A00, e);
        }
    }

    public final synchronized void A07() throws C6320dw {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (renamed) {
            ...
            try {
                ...
                throw new C6320dw(A00(123, 14, 124) + this.A00 + A00(0, 14, 84), e);
            }
        }
        throw new C6320dw(A00(166, 20, 40) + this.A00 + A00(44, 4, 124) + file + A00(14, 16, 28));
    }

    public final synchronized void A08(byte[] bArr, int i) throws C6320dw {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i);
            } else {
                throw new C6320dw(A00(73, 31, 52) + this.A00 + A00(30, 14, 118));
            }
        } catch (IOException e) {
            throw new C6320dw(String.format(Locale.US, A00(203, 53, 105), Integer.valueOf(i), this.A01, Integer.valueOf(bArr.length)), e);
        }
    }
