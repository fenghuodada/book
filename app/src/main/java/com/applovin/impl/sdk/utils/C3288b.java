...
public class C3288b {
    /* renamed from: a */
    public static MaxAdFormat m7049a(Context context) {
        return (AppLovinSdkUtils.isTablet(context) || AppLovinSdkUtils.isTv(context)) ? MaxAdFormat.LEADER : MaxAdFormat.BANNER;
    }

    /* renamed from: a */
    public static AppLovinAdSize m7047a(AttributeSet attributeSet) {
    ...
    /* renamed from: a */
    public static String m7048a(Context context, AttributeSet attributeSet, String str, String str2) {
    ...
    /* renamed from: a */
    public static void m7045a(ViewGroup viewGroup, View view) {
        if (viewGroup == null) {
            return;
        }
    ...
    /* renamed from: a */
    public static boolean m7046a(View view) {
    ...
    /* renamed from: b */
    public static boolean m7044b(AttributeSet attributeSet) {
