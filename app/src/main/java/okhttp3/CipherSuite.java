...
@Metadata(m510bv = {1, 0, 3}, m509d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\u0018\u0000 \b2\u00020\u0001:\u0001\bB\u000f\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004J\r\u0010\u0002\u001a\u00020\u0003H\u0007¢\u0006\u0002\b\u0006J\b\u0010\u0007\u001a\u00020\u0003H\u0016R\u0013\u0010\u0002\u001a\u00020\u00038\u0007¢\u0006\b\n\u0000\u001a\u0004\b\u0002\u0010\u0005¨\u0006\t"}, m508d2 = {"Lokhttp3/CipherSuite;", "", "javaName", "", "(Ljava/lang/String;)V", "()Ljava/lang/String;", "-deprecated_javaName", "toString", "Companion", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        public final synchronized CipherSuite forJavaName(@NotNull String javaName) {
            ...
            C10843j.m430f(javaName, "javaName");
        ...
        ORDER_BY_NAME = new Comparator<String>() { // from class: okhttp3.CipherSuite$Companion$ORDER_BY_NAME$1
            ...
            public int compare(@NotNull String a, @NotNull String b) {
                ...
                for (int i = 4; i < min; i++) {
                    ...
                    if (charAt != charAt2) {
                        return C10843j.m428h(charAt, charAt2) < 0 ? -1 : 1;
                    }
                }
                int length = a.length();
    ...
    public /* synthetic */ CipherSuite(String str, C10839f c10839f) {
        this(str);
    }
    ...
    @Deprecated(level = EnumC10735a.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "javaName", imports = {}))
    @JvmName(name = "-deprecated_javaName")
    @NotNull
    /* renamed from: -deprecated_javaName  reason: not valid java name */
    public final String m13119deprecated_javaName() {
