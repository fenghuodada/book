...
public final class WebSocketProtocol {
    ...
    public final String closeCodeExceptionMessage(int i) {
        ...
        if (i >= 1000 && i < 5000) {
            if ((1004 <= i && 1006 >= i) || (1015 <= i && 2999 >= i)) {
                sb = C0406q1.m12536b("Code ", i, " is reserved and may not be used.");
            } else {
                return null;
            }
        } else {
    ...
    public final void validateCloseCode(int i) {
        ...
        C10843j.m433c(closeCodeExceptionMessage);
