...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    @Metadata(m510bv = {1, 0, 3}, m509d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0005"}, m508d2 = {"Lokhttp3/internal/tls/BasicCertificateChainCleaner$Companion;", "", "()V", "MAX_SIGNERS", "", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
    /* loaded from: classes3.dex */
    ...
    public BasicCertificateChainCleaner(@NotNull TrustRootIndex trustRootIndex) {
        C10843j.m430f(trustRootIndex, "trustRootIndex");
        this.trustRootIndex = trustRootIndex;
    }

    private final boolean verifySignature(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        if (!C10843j.m435a(x509Certificate.getIssuerDN(), x509Certificate2.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        C10843j.m431e(removeFirst, "queue.removeFirst()");
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (findByIssuerAndSignature == null) {
                ...
                C10843j.m431e(it, "queue.iterator()");
                while (it.hasNext()) {
                    Object next = it.next();
                    if (next == null) {
                        throw new NullPointerException("null cannot be cast to non-null type java.security.cert.X509Certificate");
            ...
            if (arrayList.size() > 1 || (!C10843j.m435a(x509Certificate, findByIssuerAndSignature))) {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return (obj instanceof BasicCertificateChainCleaner) && C10843j.m435a(((BasicCertificateChainCleaner) obj).trustRootIndex, this.trustRootIndex);
    }
