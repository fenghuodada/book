...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    @JvmField
    @NotNull
    public static final C10918g LEGAL_KEY_PATTERN = new C10918g("[a-z0-9_-]{1,120}");
    @JvmField
    @NotNull
    ...
    @Metadata(m509d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\t\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0013\u0010\u0014R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u0006\u0010\u0007R\u0014\u0010\b\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\b\u0010\u0007R\u0014\u0010\t\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\t\u0010\u0007R\u0014\u0010\n\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\n\u0010\u0007R\u0014\u0010\u000b\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u000b\u0010\u0007R\u0014\u0010\r\u001a\u00020\f8\u0006X\u0087\u0004¢\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u000f\u0010\u0007R\u0014\u0010\u0010\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u0010\u0010\u0007R\u0014\u0010\u0011\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u0011\u0010\u0007R\u0014\u0010\u0012\u001a\u00020\u00058\u0006X\u0087D¢\u0006\u0006\n\u0004\b\u0012\u0010\u0007¨\u0006\u0015"}, m508d2 = {"Lokhttp3/internal/cache/DiskLruCache$Companion;", "", "", "ANY_SEQUENCE_NUMBER", "J", "", "CLEAN", "Ljava/lang/String;", "DIRTY", "JOURNAL_FILE", "JOURNAL_FILE_BACKUP", "JOURNAL_FILE_TEMP", "Lkotlin/text/g;", "LEGAL_KEY_PATTERN", "Lkotlin/text/g;", "MAGIC", "READ", "REMOVE", "VERSION_1", "<init>", "()V", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
    /* loaded from: classes3.dex */
    ...
    public final class Editor {
        ...
        public final void abort() throws IOException {
            synchronized (this.this$0) {
                ...
                if (C10843j.m435a(this.entry.getCurrentEditor$okhttp(), this)) {
        ...
        public final Source newSource(int i) {
            synchronized (this.this$0) {
                if (!this.done) {
                    Source source = null;
                    if (!this.entry.getReadable$okhttp() || (!C10843j.m435a(this.entry.getCurrentEditor$okhttp(), this)) || this.entry.getZombie$okhttp()) {
                        return null;
                    }
                    try {
    ...
    @Metadata(m509d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010 \n\u0002\b\u0002\n\u0002\u0010\u0016\n\u0002\b\u0005\b\u0086\u0004\u0018\u00002\u00020\u0001B/\b\u0000\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0010\u001a\u00020\u000b\u0012\f\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\t0\u0012\u0012\u0006\u0010\u0016\u001a\u00020\u0015¢\u0006\u0004\b\u0018\u0010\u0019J\u0006\u0010\u0003\u001a\u00020\u0002J\f\u0010\u0006\u001a\b\u0018\u00010\u0004R\u00020\u0005J\u000e\u0010\n\u001a\u00020\t2\u0006\u0010\b\u001a\u00020\u0007J\u000e\u0010\f\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u0007J\b\u0010\u000e\u001a\u00020\rH\u0016R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0003\u0010\u000fR\u0014\u0010\u0010\u001a\u00020\u000b8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0010\u0010\u0011R\u001a\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\t0\u00128\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0013\u0010\u0014R\u0014\u0010\u0016\u001a\u00020\u00158\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0016\u0010\u0017¨\u0006\u001a"}, m508d2 = {"Lokhttp3/internal/cache/DiskLruCache$Snapshot;", "Ljava/io/Closeable;", "", "key", "Lokhttp3/internal/cache/DiskLruCache$Editor;", "Lokhttp3/internal/cache/DiskLruCache;", "edit", "", FirebaseAnalytics.Param.INDEX, "Lokio/Source;", "getSource", "", "getLength", "Lkotlin/p;", "close", "Ljava/lang/String;", "sequenceNumber", "J", "", "sources", "Ljava/util/List;", "", "lengths", "[J", "<init>", "(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;JLjava/util/List;[J)V", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
    /* loaded from: classes3.dex */
    public final class Snapshot implements Closeable {
        ...
        public Snapshot(@NotNull DiskLruCache diskLruCache, String key, @NotNull long j, @NotNull List<? extends Source> sources, long[] lengths) {
            C10843j.m430f(key, "key");
            C10843j.m430f(sources, "sources");
            C10843j.m430f(lengths, "lengths");
            this.this$0 = diskLruCache;
            this.key = key;
            this.sequenceNumber = j;
    ...
    public DiskLruCache(@NotNull FileSystem fileSystem, @NotNull File directory, int i, int i2, long j, @NotNull TaskRunner taskRunner) {
        ...
        final String m12392a = C0484a.m12392a(new StringBuilder(), Util.okHttpName, " Cache");
        this.cleanupTask = new Task(m12392a) { // from class: okhttp3.internal.cache.DiskLruCache$cleanupTask$1
    ...
    private final void readJournal() throws IOException {
        ...
        try {
            ...
            if (!(!C10843j.m435a(MAGIC, readUtf8LineStrict)) && !(!C10843j.m435a(VERSION_1, readUtf8LineStrict2)) && !(!C10843j.m435a(String.valueOf(this.appVersion), readUtf8LineStrict3)) && !(!C10843j.m435a(String.valueOf(this.valueCount), readUtf8LineStrict4))) {
                int i = 0;
    ...
    private final void readJournalLine(String str) throws IOException {
        String substring;
        int m374r = C10929r.m374r(str, ' ', 0, false, 6);
        if (m374r != -1) {
            int i = m374r + 1;
            int m374r2 = C10929r.m374r(str, ' ', i, false, 4);
            if (m374r2 == -1) {
                substring = str.substring(i);
                C10843j.m431e(substring, "(this as java.lang.String).substring(startIndex)");
                String str2 = REMOVE;
                if (m374r == str2.length() && C10925n.m392k(str, str2, false)) {
                    this.lruEntries.remove(substring);
                    return;
                }
            } else {
                substring = str.substring(i, m374r2);
            ...
            if (m374r2 != -1) {
                String str3 = CLEAN;
                if (m374r == str3.length() && C10925n.m392k(str, str3, false)) {
                    String substring2 = str.substring(m374r2 + 1);
                    C10843j.m431e(substring2, "(this as java.lang.String).substring(startIndex)");
                    List<String> m387E = C10929r.m387E(substring2, new char[]{' '});
                    entry.setReadable$okhttp(true);
                    entry.setCurrentEditor$okhttp(null);
                    entry.setLengths$okhttp(m387E);
                    return;
                }
            }
            if (m374r2 == -1) {
                String str4 = DIRTY;
                if (m374r == str4.length() && C10925n.m392k(str, str4, false)) {
            ...
            if (m374r2 == -1) {
                String str5 = READ;
                if (m374r == str5.length() && C10925n.m392k(str, str5, false)) {
                    return;
                }
            }
    ...
    private final void validateKey(String input) {
        C10918g c10918g = LEGAL_KEY_PATTERN;
        c10918g.getClass();
        C10843j.m430f(input, "input");
        if (c10918g.f21470a.matcher(input).matches()) {
            return;
        }
    ...
    public synchronized void close() throws IOException {
        ...
        if (this.initialized && !this.closed) {
            ...
            C10843j.m431e(values, "lruEntries.values");
    ...
    public final synchronized void completeEdit$okhttp(@NotNull Editor editor, boolean z) throws IOException {
        ...
        if (!C10843j.m435a(entry$okhttp.getCurrentEditor$okhttp(), editor)) {
            throw new IllegalStateException("Check failed.".toString());
        }
