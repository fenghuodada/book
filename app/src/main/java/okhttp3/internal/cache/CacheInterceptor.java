...
public final class CacheInterceptor implements Interceptor {
    ...
    @Metadata(m510bv = {1, 0, 3}, m509d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u0004H\u0002J\u0010\u0010\u0007\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002J\u0010\u0010\u000b\u001a\u00020\b2\u0006\u0010\t\u001a\u00020\nH\u0002J\u0014\u0010\f\u001a\u0004\u0018\u00010\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\rH\u0002¨\u0006\u000f"}, m508d2 = {"Lokhttp3/internal/cache/CacheInterceptor$Companion;", "", "()V", "combine", "Lokhttp3/Headers;", "cachedHeaders", "networkHeaders", "isContentSpecificHeader", "", "fieldName", "", "isEndToEnd", "stripBody", "Lokhttp3/Response;", "response", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
    /* loaded from: classes3.dex */
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if ((!C10925n.m398e("Warning", name) || !C10925n.m392k(value, "1", false)) && (isContentSpecificHeader(name) || !isEndToEnd(name) || headers2.get(name) == null)) {
        ...
        private final boolean isContentSpecificHeader(String str) {
            return C10925n.m398e("Content-Length", str) || C10925n.m398e("Content-Encoding", str) || C10925n.m398e("Content-Type", str);
        }

        private final boolean isEndToEnd(String str) {
            return (C10925n.m398e("Connection", str) || C10925n.m398e("Keep-Alive", str) || C10925n.m398e("Proxy-Authenticate", str) || C10925n.m398e("Proxy-Authorization", str) || C10925n.m398e("TE", str) || C10925n.m398e("Trailers", str) || C10925n.m398e("Transfer-Encoding", str) || C10925n.m398e("Upgrade", str)) ? false : true;
        }
