...
public final class RealConnectionPool {
    ...
    @Metadata(m510bv = {1, 0, 3}, m509d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u000e\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006¨\u0006\u0007"}, m508d2 = {"Lokhttp3/internal/connection/RealConnectionPool$Companion;", "", "()V", "get", "Lokhttp3/internal/connection/RealConnectionPool;", "connectionPool", "Lokhttp3/ConnectionPool;", "okhttp"}, m507k = 1, m506mv = {1, 4, 0})
    /* loaded from: classes3.dex */
    ...
    public RealConnectionPool(@NotNull TaskRunner taskRunner, int i, long j, @NotNull TimeUnit timeUnit) {
        ...
        final String m12392a = C0484a.m12392a(new StringBuilder(), Util.okHttpName, " ConnectionPool");
        this.cleanupTask = new Task(m12392a) { // from class: okhttp3.internal.connection.RealConnectionPool$cleanupTask$1
        ...
        throw new IllegalArgumentException(C3132a0.m7696a("keepAliveDuration <= 0: ", j).toString());
    }
    ...
    public final boolean callAcquirePooledConnection(@NotNull Address address, @NotNull RealCall call, @Nullable List<Route> list, boolean z) {
        ...
        while (it.hasNext()) {
            ...
            C10843j.m431e(connection, "connection");
    ...
    public final void evictAll() {
        Socket socket;
        Iterator<RealConnection> it = this.connections.iterator();
        C10843j.m431e(it, "connections.iterator()");
        while (it.hasNext()) {
            RealConnection connection = it.next();
            C10843j.m431e(connection, "connection");
            synchronized (connection) {
