...
final class C10723z1 implements InterfaceC10555P1, InterfaceC10619e2 {

    /* renamed from: a */
    private double f21315a;

    /* renamed from: b */
    final /* synthetic */ double f21316b;

    /* renamed from: c */
    final /* synthetic */ InterfaceC10435j f21317c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C10723z1(double d, InterfaceC10435j interfaceC10435j) {
        this.f21316b = d;
        this.f21317c = interfaceC10435j;
    }
    ...
    public final void accept(double d) {
        this.f21315a = this.f21317c.applyAsDouble(this.f21315a, d);
    }
    ...
    public final void mo531g(long j) {
        this.f21315a = this.f21316b;
    }

    @Override // p060j$.util.function.InterfaceC10400O0
    public final Object get() {
        return Double.valueOf(this.f21315a);
    }
    ...
    public final void mo529l(InterfaceC10555P1 interfaceC10555P1) {
        accept(((C10723z1) interfaceC10555P1).f21315a);
    }
