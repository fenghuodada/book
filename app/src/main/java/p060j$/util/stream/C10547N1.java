...
final class C10547N1 implements InterfaceC10555P1, InterfaceC10629g2 {

    /* renamed from: a */
    private long f21045a;

    /* renamed from: b */
    final /* synthetic */ long f21046b;

    /* renamed from: c */
    final /* synthetic */ InterfaceC10424d0 f21047c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C10547N1(long j, InterfaceC10424d0 interfaceC10424d0) {
        this.f21046b = j;
        this.f21047c = interfaceC10424d0;
    }
    ...
    public final void accept(long j) {
        this.f21045a = this.f21047c.applyAsLong(this.f21045a, j);
    }
    ...
    public final void mo531g(long j) {
        this.f21045a = this.f21046b;
    }

    @Override // p060j$.util.function.InterfaceC10400O0
    public final Object get() {
        return Long.valueOf(this.f21045a);
    }
    ...
    public final void mo529l(InterfaceC10555P1 interfaceC10555P1) {
        accept(((C10547N1) interfaceC10555P1).f21045a);
    }
