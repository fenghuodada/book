...
public final class C10344f extends AbstractC10341c implements Set, InterfaceC10333b {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C10344f(ConcurrentHashMap concurrentHashMap) {
    ...
    public final void mo955a(Consumer consumer) {
        ...
        while (true) {
            ...
            consumer.accept(new C10350l(m967e.f20803b, m967e.f20804c, this.f20792a));
        }
    }
    ...
    public final boolean add(Object obj) {
        ...
        return this.f20792a.m988h(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f20792a.m988h(entry.getKey(), entry.getValue(), false) == null) {
                z = true;
            }
        }
        return z;
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        return (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f20792a.get(key)) == null || (value = entry.getValue()) == null || (value != obj2 && !value.equals(obj2))) ? false : true;
    }
    ...
    public final Iterator iterator() {
        ...
        return new C10343e(c10351mArr, length, length, concurrentHashMap);
    }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f20792a.remove(key, value);
    }
    ...
    public final InterfaceC10321P spliterator() {
        ...
        C10351m[] c10351mArr = concurrentHashMap.f20777a;
        int length = c10351mArr == null ? 0 : c10351mArr.length;
        return new C10345g(c10351mArr, length, 0, length, m984l >= 0 ? m984l : 0L, concurrentHashMap);
    }
